...
import DatasetLoaderComponent from './components/dataset-loader.js';
...
customElements.define('cq-dataset-loader', DatasetLoaderComponent);
...
customElements.define('cq-loading', LoadingComponent);
